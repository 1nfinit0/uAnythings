...
\title{
  ...
  \includegraphics[width=15cm]{./assets/logo-utp.png} \\
  \vspace{0.5cm}
  \textbf{Universidad Tecnológica del Perú} \\
  \vspace{0.5cm}
  \text{Análisis y Diseño de Algoritmos} \\
  \vspace{1cm}
    {\huge \textbf{Documentación: Práctica Calificada II}} \\
  \vspace{1cm}
...
\author{
  \begin{tabular}{ll}
    ...
    % \textbf{Huatay Salcedo, Luis Elías, \texttt{U71809640}}\\
  \end{tabular} \\
  \texttt{Ingeniería de Software V}\\
}
...
\maketitle
\begin{center}
  Docente: \textbf{Manuel Alejandro, Ortiz Piñella} \\
\end{center}
