...
\title{
  ...
  \vspace{0.5cm}
  \text{Análisis y Diseño de Algoritmos} \\
  \vspace{1cm}
    {\huge \textbf{Tarea 1: Análisis y Diseño de Algoritmos}} \\
  \vspace{1cm}
  % \large \textbf{Para acceder al título de...} \\
}
\author{
  \begin{tabular}{ll}
    \textbf{Huatay Salcedo, Luis Elías} & \textbf{\texttt{U71809640}}\\
    \text{Ingeniería de Software V} & \text{2026}
...
\maketitle
\begin{center}
  Docente: \textbf{Mg. Ortiz Piñella, Manuel Alejandro} \\
\end{center}
...
\include{components/documentacion/doc}
\end{document}