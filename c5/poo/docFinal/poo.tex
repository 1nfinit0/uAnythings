...
\vspace{0.5mm}\fancyhead[R]{\textit{POO}\vspace{0.5mm}}
\fancyfoot[R]{\thepage}
...
\title{
  ...
  \vspace{0.5cm}
  \text{Programación Orientada a Objetos} \\
  \vspace{1cm}
    {\textbf{Proyecto Final}} \\
    {\huge \textbf{WallpaWawqi - Punto de Venta}} \\
  \vspace{1cm}
  % \large \textbf{Para acceder al título de...} \\
}
\author{
  \begin{tabular}{ll}
    \textbf{Quispe Huisa, Daniel Gonzalo}\\
    \textbf{Huatay Salcedo, Luis Elías}\\
    \textbf{Paredes Alvarez, Paul Gheison}\\
    \textbf{Càrdenas Silva, Jorge Calet}\\
    \textbf{Manrique Gonzales, Liliana Graviela}\\
  \end{tabular} \\
  % \texttt{Ingeniería}\\
}
\begin{document}
...
% Teacher's name
% guillermo daniel vilela giron
  Docente: \textbf{Guillermo Daniel Vilela Giron} \\
\end{center}
...
\include{components/desarrollo/desarrollo}
\end{document}
